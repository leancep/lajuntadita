...
<html lang="en">
    <head>
        ...
        <?php $title="Informe - #$nuevoPedido->tamaño" ?>
...
<section class="about-section text-center" id="about">
            ...
            <div class="row">
            <div class="col-sm-6">
                <h3 class="text-yellow-50"><strong>$pedidos->tamaño</strong></h3> <br>
                ...
                <a href="https://api.whatsapp.com/send?phone=1176834985&text=Compre%20Picada%20Chica!"><img src="assets/img/whatsapp.png" alt="Whats App!" style="float:center;" width="150" height="100" /></a>
